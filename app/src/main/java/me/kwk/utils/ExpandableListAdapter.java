...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if(childText.equals( (String)getGroup( groupPosition ))) {
            txtListChild.setTextColor( Color.parseColor( "#F47320" ) );
        }else{
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        ((ImageView) convertView.findViewById(R.id.videos_group_indicator))
                .setImageResource(isExpanded?R.drawable.rectangle1:R.drawable.rectangle2);
